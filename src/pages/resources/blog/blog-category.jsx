                            ...
                            <div className="content">
                                ...
                                <ul>
                                    {recentPosts.map((recentItem, index) => (
                                        <li className="mb-2"  key={index}><Link to={`/resources/${recentItem.slug}`}>{decodeHtmlEntities(recentItem.title.rendered)}</Link></li>
                                    ))}
                                </ul>
                                ...
                                <div className="mt-5">
                                    ...
                                    <ul>                                        
                                        {category.map((item, index) => (
                                            <li className="mb-2" key={index}><Link to={item.link}>{decodeHtmlEntities(item.name)}</Link></li>
                                        ))}
                                    </ul>
                                </div>							
                            </div>
